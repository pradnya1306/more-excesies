...
# If "query" is in the list then it returns its position, otherwise it returns 
# None
...
'r','s','t','u','v','w','x','y','z']
shifted_chars = ['c','d','e','f','g','h','i','j','k','l','m','n','o','p','q',
'r','s','t','u','v','w','x','y','z','a','b']
# encrypt_message function defined here but not called
def encrypt_message(plain_msg):
# this fucnction takes "plain_msg" as an argument and print/return the encrypted 
# message. The "plain_msg" is tranfered into "encrypted_msg" using "shifted_chars" 
# list. Example, if plain_msg = "ng" then n => p, g => i  and hence 
# encrypted_msg = "pi"
...
# this fucnction takes "encrypted_msg" as an argument and print/return the 
# encrypted message. The "encrypted_msg" is tranfered into "decrypted_msg" 
# using "shifted_chars" list. Example, if encrypted_msg = "pi" then p => n, 
# i => g  and hence decrypted_msg = "ng"
